...
namespace Chartreux.Utils.DotPrinter
...
end Chartreux.Utils.DotPrinter
...
def toDotWith {A : Type} [ToString A]
  ...
  Chartreux.Utils.DotPrinter.toDotCore g (annotatorOfStates ag inSt outSt)
...
def toDotWithFn {A : Type} [ToString A]
  ...
  Chartreux.Utils.DotPrinter.toDotCore g
